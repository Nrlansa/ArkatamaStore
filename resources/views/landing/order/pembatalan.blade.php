            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-12 mb-30">
                    <div class="order-details-wrapper">
                        <h2>Daftar Pesanan anda yang dibatalkan</h2>
                        @if (count($order) > 0)
                                ...
                                @if ($item->status === 'Pesanan Dibatalkan')
                                    <div class="order-details">
                                        <ul>
                                            ...
                                            <li>
                                                    <p class="strong mb-3">Pesanan Anda telah dibatalkan secara otomatis
                                                        karena tidak melakukan pembayaran lebih dari 24 jam.</p>
                                                </li>
                                            {{-- @if ($item->status === 'menunggu verifikasi')
                                                <li>
                                                    <p class="strong mb-3">Harap menunggu hingga status pesanan anda menjadi
                                                        "Terverifikasi"</p>
                                                </li>
                                            @elseif ($item->status === 'Dalam Proses Pembayaran' || $item->status === 'tidak valid')
                                                <li>
                                                    <p>Upload bukti:</p>
                                                    <p>
                                                    <form action="{{ route('upload.bukti_bayar', $item->id) }}" method="POST"
                                            ...
                                            @else
                                                <li>
                                                    <p class="strong mb-3">Terima kasih, pesanan anda akan kami antar
                                                        menggunakan kurir.</p>
                                                </li>
                                            @endif --}}
