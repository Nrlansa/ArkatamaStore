    ...
    <div class="hero-container">
      <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="carousel-item active" style="background-image: url('{{ url('public/' .$slider->banner) }}');"></div>
        ...
        <div class="row">
            @foreach ($list_produk as $produk)
                @if ($produk->status === 'disetujui')
                    <div class="col-3">
                        <div class="card">
                            <img src="{{ url('public/' .$produk->gambar) }}" class="card-img-top" alt="..." height="200px">
                            <div class="card-body">
                                <h6 class="card-title">{{ $produk->nama }}</h6>
                                <p class="card-text">{{ $produk->formatted_price }}</p>
                                
                                <a href="{{ url('/landing', $produk->id) }}" class="btn btn-primary">Detail Produk</a>
                            </div>
                        </div>
                    </div>
                @endif
